...
insert into Produto (id, codigo, nome) values (1, '0010', 'PICOLE LIMAO');
insert into Produto (id, codigo, nome) values (2, '0012', 'PICOLE MORANGO');

insert into ProdutoPedido (id, quantidade, produto_id) values (1, 500, 1);
insert into ProdutoPedido (id, quantidade, produto_id) values (2, 500, 2);

insert into Nota (id, numeroNota, cliente_id) values (1, 16101, 1);

insert into Nota_ProdutoPedido (Nota_id, produtosPedidos_id) values (1, 1);
insert into Nota_ProdutoPedido (Nota_id, produtosPedidos_id) values (1, 2);
